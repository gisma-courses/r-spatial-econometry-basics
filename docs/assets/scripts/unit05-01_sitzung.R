...
download(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/Kreisdaten2010.csv",     destfile = "Kreisdaten2010.csv")
...
download(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/nuts3.rds",     destfile = "nuts3.rds")
...
# LAden der Geometriedaten (also die GI Daten für die NUTS3 Kreise)
download(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/lau_nuts3.rds",     destfile = "lau_nuts3.rds")
