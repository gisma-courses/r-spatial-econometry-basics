...
download.file(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/Kreisdaten2010.csv",     destfile = "Kreisdaten2010.csv")
# Aus dem Statistikkurs lesen wir die Kreisdaten ein
