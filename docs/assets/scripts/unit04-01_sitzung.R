...
download(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/Kreisdaten2010.csv",     destfile = paste0(rootDIR,"Kreisdaten2010.csv"))
