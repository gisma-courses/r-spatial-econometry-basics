...
download(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/geo_coord_city.rds",     destfile = "geo_coord_city.rds")
...
download(url ="https://raw.githubusercontent.com/gisma-courses/r-spatial-econometry-basics/master/docs/assets/data/lulc_nuts3_kreise.tif",     destfile = "lulc_nuts3_kreise.tif")
